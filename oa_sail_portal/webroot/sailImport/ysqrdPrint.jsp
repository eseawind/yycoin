		...
		<td colspan='2' align='center'>
            <table width="100%" border="0" cellspacing='0' id="mainTable">
                <tr class="content2 title">
                    <td colspan="6" align="center">预售确认单</td>
                </tr>
                <tr class="content2">
                ...
                <c:forEach items="${baseList}" var="fristBase" varStatus="vs">
                    <tr class="content2">
                        ...
                        <td></td>
                        <td>${fristBase.price * fristBase.amount}</td>
                    </tr>
                </c:forEach>
                ...
                <tr class="content2">
                    <td colspan="6"><p align="center">预约通知</p>
                        1.	预约购买申请仅作为预约申请依据，不作为购买产品确认，有可能因库存产品不足导致购货失败<br>
                        2.	请妥善保管、预约申请后凭此联及有效证件 、扣款单进行提货<br>
                        3.	贵金属产品一经售出，概不退货<br>
                        4.	自预约之日起超过六十工作日未提货的，银行按每天千分之一收保管费<br>
                    </td>
                </tr>
