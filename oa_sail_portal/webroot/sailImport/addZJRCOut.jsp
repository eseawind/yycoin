...
function opens(obj)
{
    oo = obj;
    // 配件
    window.common.modal('../sail/extout.do?method=rptQueryZJRCProduct&load=1&id=' + obj.productid + '&init=1');
}
...
<form name="outForm" method="post" action="../sail/extout.do?method=addZJRCOut">
				...
				<table width="100%" border="0" cellspacing='1'>
					<tr class="content2">
						...
						<td width="35%"><input type="text" name="outTime"
							value="${current}" maxlength="20" size="20" readonly="readonly"><font
					...
					<tr class="content2">
						...
						<td colspan="3">选择地址：&nbsp;&nbsp;<select name="provinceId" quick=true
							onchange="changes(this)" class="select_class" oncheck="notNone;">
							</select>&nbsp;&nbsp; <select name="cityId" quick=true onchange="changeArea()"
							class="select_class" oncheck="notNone;"></select>&nbsp;&nbsp; 
							<select name="areaId" quick=true class="select_class" oncheck="notNone;"></select>&nbsp;&nbsp; <font color="#FF0000">*</font>
						</td>
					</tr>

					<tr class="content1">
						<td></td>
						<td colspan="3">详细地址：&nbsp;&nbsp;<input type="text" name="address" oncheck="notNone;" size=100
					...
					<tr class="content2">
						...
						<td colspan="3">
						<input type="text" name="receiver" oncheck="notNone;" size=20
					...
					<tr class="content1">
						...
						<td colspan="3"><input type="text" name="handPhone"
					...
					<tr class="content2">
						...
						<td colspan="3"><textarea rows="2" cols="55" name="shipDescription"></textarea></td>
					</tr>

					<tr class="content1">
						<td align="right">发票抬头：</td>
						<td colspan="3"><input type="text" name="invoiceHead" size="60"
							maxlength="60"></td>
					</tr>
					...
					<tr class="content2">
						...
						<td colspan="3"><textarea rows="2" cols="55"
							name="invoiceDetail"></textarea></td>
					</tr>

					<tr class="content1">
						<td align="right">发票备注：</td>
						<td colspan="3"><textarea rows="2" cols="55"
							name="invoiceDescription"></textarea></td>
					</tr>
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing='1' id="tables">
					...
					<tr class="content1" id="trCopy" style="display: none;">
						...
						<td align="center"><input type="text" style="width: 100%"
							maxlength="13" onkeyup="cc(this)" onblur="blu(this)"
					...
					<tr class="content2">
						...
						<td align="center"><input type="text" style="width: 100%"
							id="unAmount" maxlength="8" onkeyup="cc(this)" name="amount"></td>

						<td align="center"><input type="text" style="width: 100%"
							id="unPrice" maxlength="13" onkeyup="cc(this)"
							onblur="blu(this)" name="price" readonly="readonly"></td>
