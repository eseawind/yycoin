...
function load()
{
    ...
    $detail($O('viewTable'), ['pr', 'ba', 'price', 'inputPrice', 'description','adescription', 'reday', 'dutyId', 'invoiceId']);
...
<table width="95%" border="0" cellpadding="0" cellspacing="0" id="viewTable"
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing='1'>
                    ...
                    <tr class="content1">
                        ...
                        <td colspan="3">
                       <select name=adescription class="select_class" oncheck="notNone;" onchange="reasonChange()">
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing='1' id="tables">
                    ...
                    <tr class="content2">
                        ...
                        <td align="center"><input type="text"  value="${my:formatNum(fristBase.inputPrice)}"
                            style="width: 100%" name="inputPrice">
	...
	<tr>
        ...
        <div align="right"><input type="button" name="pr"
            class="button_class" onclick="outRepaire()"
            value="&nbsp;&nbsp;申请空开空退&nbsp;&nbsp;">&nbsp;&nbsp;<input
