...
function opens(obj)
{
	...
	window.common.modal('../depot/storage.do?method=rptQueryStorageRelationInDepot&showAbs=1&load=1&depotId='
	           + $$('location') + '&name=' + encodeURIComponent(obj.value) + '&mtype=' + mtype+ '&tmpdutyid=' + $("#dutyId").val());
}
...
<input type=hidden name="eventId" value="${bean.eventId}" />
<input type=hidden name="refBindOutId" value="${bean.refBindOutId}" />
