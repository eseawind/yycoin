...
<form name="formEntry" action="../sail/out.do" method="post"><input
	type="hidden" name="method" value="queryTabOrder">
	...
	<p:subBody width="100%">
		<table width="100%" align="center" cellspacing='1' class="table0"
			...
			<tr align=center class="content0">
				...
				<td align="center" width="9%"><strong>单据类型</strong></td>
			</tr>

			<c:forEach items="${beanList}" var="item" varStatus="vs">
				<tr class="${vs.index % 2 == 0 ? 'content1' : 'content2'}">
					<td align="center" onclick="hrefAndSelect(this)"><a href="../sail/out.do?method=findOut&outId=${item.fullId}" />${item.fullId}</a></td>
					<c:if test="${item.type==0}">
					<td align="center" onclick="hrefAndSelect(this)">销售单</td>
					</c:if>
					<c:if test="${item.type==1}">
					<td align="center" onclick="hrefAndSelect(this)">入库单</td>
					</c:if>
		...
		<p:formTurning form="formEntry" method="queryTabOrder"></p:formTurning>
