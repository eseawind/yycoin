...
<p:navigation height="22">
	<td width="550" class="navigation"><span style="cursor: pointer;"
		onclick="javascript:history.go(-1)">销售审核规则管理</span> &gt;&gt; 修改销售审核规则</td>
	<td width="85"></td>
</p:navigation> <br>
...
<p:body width="100%">
	...
	<p:subBody width="98%">
		<p:class value="com.china.center.oa.sail.bean.AuditRuleBean" opr="1"/>
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing='1' id="tables">
					<tr align="center" class="content0">
						...
						<td width="6%" align="center">付款条件<font color="#FF0000">*</font></td></td>
					...
					<c:forEach items="${itemList}" var="item" varStatus="vs">
                        <tr class='${vs.index % 2 == 0 ? "content1" : "content2"}'>
							<td width="6%" align="center">         
								<select name="p_managerType" class="select_class" values="${item.managerType}" style="width: 100%;">
							...
							<td width="6%" align="center">         
								<select name="p_materialType" class="select_class" values="${item.materiaType}" style="width: 100%;">
					            	<p:option type="201" empty="true"></p:option>
					         	</select>
							</td>
							<td width="6%" align="center">
								<select name="p_currencyType" class="select_class" values="${item.currencyType}" style="width: 100%;">
							...
							<td width="6%" align="center">         
								<select name="p_payCondition" class="select_class" values="${item.payCondition}" style="width: 100%;" oncheck="notNone">
					            	<p:option type="payCondition" empty="true"></p:option>
					         	</select>
							</td>
							<td width="6%" align="center">
					         	<input name="p_accountPeriod" style="width: 100%;" value="${item.accountPeriod}" oncheck="range(0, 180)"/>
							</td>	
							<td width="6%" align="center">         
								<input name="p_productPeriod" style="width: 100%;" value="${item.productPeriod}" oncheck="range(0, 180)"/>
							</td>
							<td width="7%" align="center">
								<input name="p_ratioDown" style="width: 100%;" value="${item.ratioDown}" oncheck='range(0, 100)' />
							</td>
							<td width="7%" align="center">
								<input name="p_ratioUp" style="width: 100%;" value="${item.ratioUp}" oncheck='range(0, 100)' />
							</td>
							<td width="6%" align="center">
					         	<input name="p_profitPeriod" style="width: 100%;" value="${item.profitPeriod}" oncheck="range(0, 180)"/>
							</td>	
							<td width="6%" align="center">         			
								<select name="p_ltSailPrice" class="select_class" values="${item.ltSailPrice}" style="width: 100%;">
					            	<p:option type="lessThanSailPrice" empty="true"></p:option>
					         	</select>
							</td>
							<td width="6%" align="center">
								<input name="p_diffRatio" style="width: 100%;" value="${item.diffRatio}" oncheck='isFloat;' />
							</td>
							<td width="6%" align="center">
								<input name="p_minRatio" style="width: 100%;" value="${item.minRatio}" oncheck='isFloat;' />
							</td>
...
<table>
	<tr class="content1" id="trCopy" style="display: none;">
		...
		<td width="6%" align="center">         
			<select name="p_payCondition" class="select_class" style="width: 100%;">
            	<p:option type="payCondition" empty="true"></p:option>
         	</select>
		</td>
		<td width="6%" align="center">
