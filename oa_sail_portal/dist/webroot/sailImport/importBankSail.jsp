...
<html>
<head>
<p:link title="银行销售数据导入" />
<script language="JavaScript" src="../js/common.js"></script>
<script language="JavaScript" src="../js/JCheck.js"></script>
<script language="javascript">
function addBean()
{
	submit('确定导入银行销售数据信息?', null, checkValue);
}
...
function changeAction()
{
	...
	$O('formEntry').action="../sail/outImport.do?method=importBankSail";
}
...
<form name="formEntry"
	action="../sail/outImport.do?method=importBankSail"
...
<p:body width="100%">
	...
	<p:subBody width="80%">
		...
		<p:table cells="1">
			<p:cell title="导入模板">
				<a target="_blank"
					href="../admin/down.do?method=downTemplateFileByName&fileName=bankSailIntfTemplate.xls">下载销售数据导入模板</a>
			</p:cell>
		</p:table>
