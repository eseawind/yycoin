...
function addBean()
{
	submit('确定批量更新配送地址信息?', null, checkValue);
}
...
<form name="formEntry"
	action="../sail/outImport.do?method=batchUpdateDistAddr"
...
<p:body width="100%">
	...
	<p:subBody width="80%">
		...
		<p:table cells="1">
			<p:cell title="导入模板">
				<a target="_blank"
					href="../admin/down.do?method=downTemplateFileByName&fileName=distAddrTemplate.xls">下载配送地址导入模板</a>
			</p:cell>
		</p:table>
