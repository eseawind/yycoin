...
<input type=hidden name="flowId" value="${bean.flowId}">
<p:navigation
	height="22">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing='1' id="tables">					
					...
					<tr class="content2">
						<td>
							<select id="unLocationId" name="locationIds" class="select_class" values="${fristBase.locationId}" onchange="clearsItem(this)" style="width: 100%">
								    <option value="">--</option>
									<c:forEach items='${locationList}' var="item">
										<option value="${item.id}">${item.name}</option>
									</c:forEach>
                    ...
                    <tr class="content2">
						<td>
							<select name="locationIds" class="select_class" values="${fristBase.locationId}" onchange="clearsItem(this)" style="width: 100%">
								    <option value="">--</option>
									<c:forEach items='${locationList}' var="item">
										<option value="${item.id}">${item.name}</option>
									</c:forEach>
						...
						<td align="center">
							<input type="text" value="${my:formatNum(fristBase.taxrate)}"
								readonly="readonly" style="width: 100%" name="taxrate">		
						</td>
							
						<td align="center"><input type="text" readonly="readonly" value="${my:formatNum(fristBase.tax)}"
							style="width: 100%" name="tax"></td>                            
