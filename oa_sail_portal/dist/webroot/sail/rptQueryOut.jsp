	...
	<p:subBody width="98%">
		<table width="100%" align="center" cellspacing='1' class="table0"
			...
			<tr align=center class="content0">
				...
				<td align="center" width="10%"><strong>纳税实体</strong></td>
				...
				<td align="center" width="10%"><strong>折扣金额</strong></td>
				<td align="center" width="5%"><strong>状态</strong></td>
				<td align="center" width="10%"><strong>退货金额</strong></td>
				<td align="center" width="15%"><strong>时间</strong></td>
			</tr>
			...
			<c:forEach items="${list}" var="item" varStatus="vs">
				<tr class="${vs.index % 2 == 0 ? 'content1' : 'content2'}">
					...
					plast="${my:formatNum(item.total -item.hadPay - item.retTotal - item.badDebts - item.promValue)}"
		...
		<p:formTurning form="formEntry" method="rptQueryOut"></p:formTurning>
