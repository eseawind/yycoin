					...
					<tr>
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="10">
							<tr>
								...
								信用担保：
								<select name="guarantor" style="width: 300px">
                                    <c:forEach items='${mList}' var="item">
                                        <option value="${item.id}">${item.description}</option>
                                    </c:forEach>
                                </select>
                                &nbsp;&nbsp;<strong>${swatchMoney}</strong>
								</td>
							</tr>
						</table>
						</td>
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing='1'>
					...
					<tr id="presentTR" class="content1" style="display: none;">
						...
						<td colspan="3"><select name="presentFlag" class="select_class" >
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing='1' id="tables">
					...
					<tr class="content2">
						<td>
							<select id="unLocationId" name="locationIds" class="select_class" onchange="clearsItem(this)" style="width: 100%">
								    <option value="">--</option>
									<c:forEach items='${locationList}' var="item">
										<option value="${item.id}">${item.name}</option>
									</c:forEach>
						...
						<td align="center"><input type="text" readonly="readonly" id="unTax" value="0.00"
							style="width: 100%" name="tax"></td>							
