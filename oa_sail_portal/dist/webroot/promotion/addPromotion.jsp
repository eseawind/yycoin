...
<p:navigation height="22">
	<td width="550" class="navigation"><span style="cursor: pointer;"
		onclick="javascript:history.go(-1)">促销规则管理</span> &gt;&gt; 增加促销规则</td>
	<td width="85"></td>
</p:navigation> <br>
...
<p:body width="100%">
	...
	<p:subBody width="98%">
		<p:class value="com.china.center.oa.sail.bean.PromotionBean" />

		<p:table cells="2">
			
			<p:pro field="name" cell="0" innerString="size=80" />

			<p:pro field="minAmount" value="0" innerString="size=20 oncheck='isMathNumber'" />
			
			<p:pro field="maxAmount" value="0" innerString="size=20 oncheck='isMathNumber'" />
			
			<p:pro field="minMoney" value="0.0" innerString="oncheck='isFloat'" cell="0"/>
			...
			<p:pro field="rebateMoney" value="0.0" innerString="oncheck='isFloat'" cell="0" />
			
			<p:pro field="custCredit" value="0" innerString="size=20 oncheck='isMathNumber'" />
			
			<p:pro field="busiCredit" value="0" innerString="size=20 oncheck='isMathNumber'" />
			
			<p:pro field="isReturn" cell="0">
				<p:option type="isReturn"></p:option>
			</p:pro>
			
			<p:pro field="rebateRate" value="0" innerString="size=20 oncheck='isMathNumber'" />
			
			<p:pro field="maxRebateMoney" value="0.0" innerString="oncheck='isFloat'" />
