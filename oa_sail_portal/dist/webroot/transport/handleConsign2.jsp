...
function sub1()
{
	...
	if ($$('currentStatus') == 99)
	{
		if (compareDays($$('now'), $$('passDate')) != 0 && $$('distId').indexOf('PS') > 0)
		{
...
<p:body width="100%">
	...
	<p:subBody width="98%">
		<p:table cells="1" id="showTable">
				    ...
				    <tr class="content1">
                     <td width="15%">收货人：</td>
                        <td colspan="3"><input type="text" value="${consignBean.reveiver}" name="reveiver"></td>
                    </tr>
	            ...
	            <tr>
	                ...
	                <table width="100%" border="0" cellspacing='1' id="tables">
	                    <tr align="center" class="content0">
							...
							<td width="5%" align="center">件数)</td>
	                        <td width="5%" align="center">重量(KG)</td>
	                        <td width="5%" align="center">运费(元)</td>
                    	...
                    	<td align="left">
				         ...
				         <td align="left"><input type="text" style="width: 100%" 
				         						name="transportNo" id="transportNo"
				         ...
				         <td align="left">
				         <input type="text" style="width: 100%"
				         		name="preparer" value="${item.preparer}" class="input_class" onclick=selectStaffer(this)>
				         </td>
				         
				         <td align="left">
				         <input type="text" style="width: 100%"
				         		name="checker" value="${item.checker}" class="input_class" onclick=selectStaffer(this)>
				         </td>
				         
				         <td align="left">
				         <input type="text" style="width: 100%"
				         		name="packager" value="${item.packager}" class="input_class" onclick=selectStaffer(this)>
				         </td>
				        ...
				        <td width="8%" align="center"><input type=button name="view_bu"
				            ...
				            <input type=button name="pay_del_bu"
...
<table>
    <tr class="content1" id="trCopy" style="display: none;">
         ...
         <td align="left"><input type="text" style="width: 100%" 
         						name="transportNo" id="transportNo"
         						value="" class="input_class">
         </td>
         
         <td align="left">
         <input type="text" style="width: 100%"
         		name="sendPlace" value="" class="input_class">
         </td>
         ...
         <td align="left">
         <input type="text" style="width: 100%"
         		name="preparer" value="" class="input_class" onclick=selectStaffer(this)>
         </td>
         
         <td align="left">
         <input type="text" style="width: 100%"
         		name="checker" value="" class="input_class" onclick=selectStaffer(this)>
         </td>
         
         <td align="left">
         <input type="text" style="width: 100%"
         		name="packager" value="" class="input_class" onclick=selectStaffer(this)>
         </td>
         
         <td align="left">
         <input type=text name = 'packageTime'  id = 'packageTime'  value=""
         readonly=readonly class='input_class' size = '15' ><img src='../images/calendar.gif' style='cursor: pointer' title='请选择时间' align='top' onclick='return calDateTimeInner(this, "packageTime");' height='20px' width='20px'/>
         </td>
         
         <td align="left">
         <input type="text" style="width: 100%"
         		name="mathine" value="" class="input_class">
         </td>
         
         <td align="left">
         <input type="text" style="width: 100%"
         		name="packageAmount" value="" class="input_class">
         </td>
         
         <td align="left">
         <input type="text" style="width: 100%"
         		name="packageWeight" value="" class="input_class">
         </td>
         
         <td align="left">
         <input type="text" style="width: 100%"
                    name="transportFee" value="0.00">
         </td>
