...
<table width="100%" border="0" cellpadding="0"
	...
	<tr>
		...
		<table width="100%" height="26" border="0" cellpadding="0"
			...
			<tr>
				<td width="21"></td>
				<td width="162"><font color="blue" size="2">SKY-OA系统</font></td>
				<td width="5"></td>
			</tr>
		</table>
		</td>
	...
	<tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<!--DWLayoutTable-->
			<tr>
				<td width="784" height="100"></td>
			</tr>
			<tr>
				<td height="200" align="center" valign="top" class="background">
				<table border="0" cellspacing="8">
					<tr>
						<td>
						<div align="center" style="cursor:pointer;" ><img
							src="../images/succeed.gif" width="84" height="35"></div>
						</td>
					</tr>
					<tr>
						<td><span class="style1"><font size="3"><strong>${MESSAGE_INFO}
						操作成功</strong></font></span></td>
					</tr>
					<tr>
						<td></td>
					</tr>
