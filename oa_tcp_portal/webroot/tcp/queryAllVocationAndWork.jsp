...
function load()
{
     ...
     guidMap = {
         title: '请假/加班列表',
         url: gurl + 'queryAllVocationAndWork',
         colModel : [
             ...
             {display: '目的类型', name : 'purposeType', cc: 'purposeTypeContent',width : '10%'},
             {display: '请假类型', name : 'vocationType',cc:'vocationTypeContent', width : '10%'},
             {display: '详情', name : 'qingJiapurpose', width : '20%'},
...
function delBean(opr, grid)
{
    ...
    {    
        ...
        $ajax(gurl + 'deleteTravelApply&id=' + getRadioValue('checkb'), callBackFun);
    }
    else
    $error('不能操作');
}
