...
function addBean(opr)
{
    ...
    if ("0" == opr)
    {
        submit('确定修改中收申请?', null, checks);
    }
    
    if ("1" == opr)
    {
        submit('确定提交中收申请?', null, checks);
    }
    
    if ("2" == opr)
    {
        submit('稽核修改费用,每项费用只能减少.确定提交稽核修改中收申请?', null, checks);
    }
}
...
<p:navigation height="22">
	<td width="550" class="navigation">中收申请</td>
	<td width="85"></td>
</p:navigation> <br>
