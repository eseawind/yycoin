...
<html>
<head>
<p:link title="业务招待费报销" guid="true"/>
...
<p:navigation height="22">
	<td width="550" class="navigation"><span style="cursor: pointer;"
        onclick="javascript:history.go(-1)">待我处理</span> &gt;&gt; 业务招待费报销处理</td>
    <td width="85"></td>
</p:navigation> <br>
...
<p:body width="100%">
	...
	<p:title>
		<td class="caption">
		 <strong>业务招待费报销-${my:get('tcpStatus', bean.status)}</strong>
		</td>
	</p:title>
