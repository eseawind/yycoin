...
<p:navigation height="22">
	<td width="550" class="navigation">修改申请预收退款</td>
	<td width="85"></td>
</p:navigation> <br>
...
<p:body width="100%">
	...
	<p:subBody width="98%">
	    ...
	    <p:class value="com.china.center.oa.finance.bean.BackPrePayApplyBean" opr="1"/>
		...
		<p:table cells="2">
            ...
            <a target="_blank" href="../tcp/backprepay.do?method=downAttachmentFile&id=${item.id}">${item.name}</a>&nbsp;
            <c:if test="${update == 1}">
