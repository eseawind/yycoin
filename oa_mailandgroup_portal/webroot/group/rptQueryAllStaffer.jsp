...
<form name="formEntry" action="../group/group.do" method="post">
<input	type="hidden" name="method" value="rptQueryAllStaffer">
...
<input
	...
	height="22">
	<td width="550" class="navigation">所有职员</td>
	<td width="85"></td>
</p:navigation> <br>
...
<p:body width="100%">
	...
	<p:title>
		...
		<c:if test="${stavo.postId==4 }">部门经理</c:if>
		<c:if test="${stavo.postId==17 }">事业部负责人</c:if>
		<c:if test="${stavo.postId==16 }">总裁</c:if>
		</strong></td>
	</p:title>
	...
	<p:subBody width="97%">
		<table width="100%" align="center" cellspacing='1' class="table0"
			...
			<tr align=center class="content0">
				...
				<td align="center" width="6%"><strong>编码</strong></td>
				<td align="center" width="65%"><strong>部门</strong></td>
				<td align="center" width="9%"><strong>区域</strong></td>
			</tr>

			<c:forEach items="${beanList}" var="item" varStatus="vs">
				<tr class="${vs.index % 2 == 0 ? 'content1' : 'content2'}">
					<td align="center"><input type='${selectMode == 1 ? "radio" : "checkbox"}' name="beans"
						pname="${item.name}" pvalue="${item.id}"
					...
					<td align="center" onclick="hrefAndSelect(this)">${item.locationId}</td>
				</tr>
			</c:forEach>
		</table>
