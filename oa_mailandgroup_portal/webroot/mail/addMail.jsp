...
<input
	...
	<td width="550" class="navigation"><span style="cursor: pointer;"
		onclick="javascript:history.go(-1)">邮件管理</span> &gt;&gt; 新建邮件</td>
	<td width="85"></td>
</p:navigation> <br>
...
<p:body width="100%">
	...
	<p:subBody width="98%">
		<p:table cells="1" id="tables">
			...
			<p:cell title="收件人" width="8"><input type="text" name="senderName" title="点击选择职员" size="80" readonly="readonly" style="cursor: pointer;" onclick="selectStaffer(0)" oncheck="notNone;"> <font color="red">*</font>
			<span style="cursor: pointer;" onclick="selectGroup(0)">选择群组</span>
			</p:cell>
			<p:cell title="抄送人" width="8"><input type="text" name="senderName2" size="80" title="点击选择职员" readonly="readonly" style="cursor: pointer;" onclick="selectStaffer(1)"> <font color="red">&nbsp;</font>
			<span style="cursor: pointer;" onclick="selectGroup(1)">选择群组</span>
			</p:cell>
			<p:cell title="主题" width="8"><input type="text" name="title" size="80" maxlength="200" oncheck="notNone;">  <font color="red">*</font></p:cell>
			...
			<p:cell title="内容" width="8"><textarea name="content" rows="25" oncheck="maxLength(500)" style="width: 100%"></textarea></p:cell>
