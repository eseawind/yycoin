...
<html>
<head>
<p:link title="资产负债表" cal="true" guid="true"/>
...
<p:navigation
	height="22">
	<td width="550" class="navigation">资产负债表</td>
	<td width="85"></td>
</p:navigation> <br>
...
<p:body width="100%">
	...
	<p:title>
		<td class="caption"><strong>资产负债表：</strong></td>
	</p:title>
	...
	<p:subBody width="98%">
		<table width="100%" align="center" cellspacing='1' class="table0" id="dataTable">
			...
			<c:forEach items="${g_tax_rep_resultList0}" var="item"
				varStatus="vs">
