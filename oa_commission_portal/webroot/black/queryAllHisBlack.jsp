...
function load()
{
     ...
     guidMap = {
         ...
         extAtt: {
	    	 money : {begin : '<a title=点击查看明细  href=' + gurl + 'findHisBlack&id={id}&type=0&firstLoad=1>', end : '</a>'},
	    	 days : {begin : '<a title=点击查看明细 href=' + gurl + 'findHisBlack&id={id}&type=1&firstLoad=1>', end : '</a>'},
	    	 allMoneys : {begin : '<a title=点击查看明细 href=' + gurl + 'findHisBlack&id={id}&type=2&firstLoad=1>', end : '</a>'}
         },
         buttons : [
...
function doSearch()
{
    $modalQuery('../admin/query.do?method=popCommonQuery2&key=queryHis' + ukey);
}
...
function exports()
{
    ...
    {
    document.location.href = '../commission/black.do?method=exportAllHisBlackStaffer';
    }
}
...
function exports1()
{
    if (window.confirm('确定导出所有黑名单?'))
    {
    document.location.href = '../commission/black.do?method=exportAllHisBlackMoney';
    }
}
...
function exports2()
{
    ...
    {
    document.location.href = '../commission/black.do?method=exportAllHisBlackDetail';
    }
}
