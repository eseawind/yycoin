...
<p:navigation height="22">
	<td width="550" class="navigation"><span style="cursor: pointer;"
		onclick="javascript:history.go(-1)">黑名单例外规则管理</span> &gt;&gt; 修改黑名单例外规则</td>
	<td width="85"></td>
</p:navigation> <br>
...
<p:body width="100%">
	...
	<p:subBody width="98%">
		<p:class value="com.china.center.oa.commission.bean.BlackRuleBean" opr="1"/>
		...
		<p:table cells="2">
			...
			<p:cell title="品类" end="true">
				<textarea name='productTypeName'
					head='品类' id='productTypeName' rows=2 cols=80 readonly=true"><c:out value="${bean.productTypeName}" /></textarea><input
			...
			<p:cell title="销售单号" end="true">
				<textarea name='outId'
					...
					><c:out value="${bean.outId}"/></textarea>
			</p:cell>
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing='1' id="tables">
					<tr align="center" class="content0">
						<td width="95%" align="center">产品名称</td>
					...
					<c:forEach items="${itemList}" var="item" varStatus="vs">
                        <tr class='${vs.index % 2 == 0 ? "content1" : "content2"}'>
                        		<td width="95%" align="center"><input type="text"
		...
		<table width="98%" border="0" cellpadding="0" cellspacing="0"
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing='1' id="tables_staffer">
					<tr align="center" class="content0">
						<td width="95%" align="center">职员</td>
						<td width="5%" align="left"><input type="button"
							accesskey="A" value="增加(A)" class="button_class"
