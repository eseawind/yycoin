...
<input type="hidden" name="method" value="findCommission5"> 
...
<p:body width="100%">
	...
	<p:title>
		<td class="caption"><strong>报废明细：</strong></td>
	</p:title>
	...
	<p:subBody width="98%">
		<table width="100%" align="center" cellspacing='1' class="table0" id="senfe">
			...
			<c:forEach items="${beanList}" var="item"
				...
				<tr class="${vs.index % 2 == 0 ? 'content1' : 'content2'}">
					...
					<td align="left">${my:formatNum(item.value)}</td>
		...
		<p:formTurning form="formEntry" method="findCommission5"></p:formTurning>
