...
<input type="hidden" name="method" value="findCommission3"> 
...
<p:body width="100%">
	...
	<p:title>
		<td class="caption"><strong>费用明细：</strong></td>
	</p:title>
	...
	<p:subBody width="98%">
		<table width="100%" align="center" cellspacing='1' class="table0" id="senfe">
			<tr align=center class="content0">
				...
				<td align="center" class="td_class" onclick="tableSort(this)"><strong>费用</strong></td>
				<td align="center" class="td_class" onclick="tableSort(this)"><strong>关联单据</strong></td>
				<td align="center" class="td_class" onclick="tableSort(this)"><strong>费用备注</strong></td>
			</tr>
		...
		<p:formTurning form="formEntry" method="findCommission3"></p:formTurning>
