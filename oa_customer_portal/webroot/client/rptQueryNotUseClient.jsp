...
<form name="formEntry" action="../client/client.do" method="post"><input
	type="hidden" name="method" value="rptQueryNotUseClient">
	...
	<p:subBody width="90%">
		<table width="100%" align="center" cellspacing='1' class="table0"
			...
			<tr align=center class="content0">
				...
				<td align="center" width="30%"><strong>名称</strong></td>
		...
		<p:formTurning form="formEntry" method="rptQueryNotUseClient"></p:formTurning>
