...
function load()
{
	 guidMap = {
		 title: '申请客户列表',
		 url: '../client/client.do?method=queryApplyClient',
		 colModel : [
		 ...
		 extAtt: {
		     name : {begin : '<a href=../client/client.do?method=findApplyClient&id={id}&updateCode='+ updateCode + '>', end : '</a>'}
		 },
		 buttons : [
...
function delBean()
{
    if (getRadio('checkb') && getRadioValue('checkb'))
    {
        ...
        {
            $ajax('../client/client.do?method=delApplyClient&id=' + getRadioValue('checkb'), callBackFun);
        }
    }
}
