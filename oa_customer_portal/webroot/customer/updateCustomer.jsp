...
<form name="addApply" action="../customer/customer.do" method="post"><input
	type="hidden" name="method" value="addUpdateApplyCustomer">
<input type="hidden" name="id" value="${bean.id}">
<input type="hidden" name="createTime" value="${bean.createTime}">
	 <p:navigation
	height="22">
	<td width="550" class="navigation"><span style="cursor: pointer;"
		onclick="javascript:history.go(-1)">客户管理</span> &gt;&gt; 申请修改客户</td>
	<td width="85"></td>
</p:navigation> <br>
<p:body width="100%">
	...
	<p:subBody width="98%">
		...
		<p:table cells="2">
			...
			<p:pro field="code" cell="2" innerString="size=60 readonly=readonly"/>
