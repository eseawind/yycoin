...
function sures2()
{
	...
	var stafferId = $$('stafferId');

    opener.getAllCustomer(stafferId);
...
<form name="formEntry" action="../customer/customer.do" method="post"><input
	type="hidden" name="method" value="rptQueryMultiCustomerByStaff">
...
<p:body width="100%">
	...
	<p:subBody width="90%">
		<table width="100%" align="center" cellspacing='1' class="table0"
			...
			<c:forEach items="${list}" var="item" varStatus="vs">
				<tr class="${vs.index % 2 == 0 ? 'content1' : 'content2'}">
					<td align="center"><input type='${selectMode == 1 ? "radio" : "checkbox"}' name="beans" pval="${my:formatNum(item.creditVal)}"
					    plever="${item.lever}"
		...
		<p:formTurning form="formEntry" method="rptQueryMultiCustomerByStaff"></p:formTurning>
	...
	<p:button leftWidth="95%" rightWidth="0%">
		...
		<input type="button" class="button_class"
			id="adds2" style="cursor: pointer" value="&nbsp;&nbsp;全部(含所有页)&nbsp;&nbsp;"
			onclick="sures2()">
		<input type="button" class="button_class"
