...
function reclaimBeans(flag)
{
    ...
    if (clis.length > 0)
    {
        ...
        {
            $ajax('../customer/customer.do?method=reclaimAssignCustomer&customerIds=' + str + '&type=' + type + '&destStafferId='+destStafferId, callBackFun);
        }
    }
}
...
function $process(flag)
{
    ...
    {
	    $ajax('../customer/customer.do?method=reclaimStafferCustomer&stafferId=' + sid + '&flag=' + flag + '&destStafferId=' + destStafferId, callBackFun);
