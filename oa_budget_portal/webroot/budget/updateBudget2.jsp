...
<form name="formEntry" action="../budget/budget.do" method="post"><input
	...
	<td width="550" class="navigation"><span style="cursor: pointer;"
		onclick="javaScript:window.history.go(-1);">预算管理</span> &gt;&gt; 变更预算</td>
	<td width="85"></td>
</p:navigation> <br>
...
<p:body width="100%">
	...
	<p:title>
		<td class="caption"><strong>预算基本信息：(变更后的预算金额不能比变更前大)</strong></td>
	</p:title>
	...
	<p:subBody width="98%">
		...
		<p:table cells="2" id="infoTable">
            ...
            <textarea rows=4 cols=60 name="applyReason" oncheck="notNone" head="变更说明"></textarea><font color="red">*</font></p:cells>
		</p:table>
	</p:subBody>
	...
	<p:button leftWidth="100%" rightWidth="0%">
		<div align="right"><input type="button" class="button_class"
			...
			value="&nbsp;&nbsp;变更提交&nbsp;&nbsp;" onclick="addBean(1)"></div>
	</p:button>
</p:body></form>
