...
function add()
{
    ...
    if (oo)
    opener.getDepartmentYearBudgets(oo);
}
...
<form name="formEntry" action="../budget/budget.do" method="post"><input
	type="hidden" name="method" value="rptQueryDepartmentYearBudget"><input
...
<p:body width="100%">
	...
	<p:subBody width="90%">
		...
		<p:formTurning form="formEntry" method="rptQueryDepartmentYearBudget"></p:formTurning>
