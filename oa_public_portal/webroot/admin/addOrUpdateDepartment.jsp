...
<form name="formEntry" action="../admin/common.do"><input
	type="hidden" name="method" value="addOrUpdateDepartment"><input id="id"
    type="hidden" name="id" value="${bean.id}"> <p:navigation
	height="22">
	<td width="550" class="navigation"><span style="cursor: pointer;"
		onclick="javascript:history.go(-1)">部门管理</span> &gt;&gt; <font id="navigation">增加部门</font></td>
	<td width="85"></td>
</p:navigation> <br>
...
<p:body width="100%">
	...
	<p:title>
		<td class="caption"><strong>部门基本信息：</strong></td>
	</p:title>
