...
<p:navigation
	height="22">
	<td width="550" class="navigation">收货人管理</td>
	<td width="85"></td>
</p:navigation> <br>

<p:body width="100%">
	<p:title>
		<td class="caption"><strong>收货人列表：</strong></td>
	</p:title>
	...
	<p:subBody width="90%">
		<table width="100%" align="center" cellspacing='1' class="table0"
			...
			<tr align=center class="content0">
				...
				<td align="center"><strong>收货人电话</strong></td>
			</tr>

			<c:forEach items="${item}" var="item" varStatus="vs">
				<tr class="${vs.index % 2 == 0 ? 'content1' : 'content2'}">
					<td align="center"><input type='${selectMode == 1 ? "radio" : "checkbox"}' name="beans"
					${vs.index == 0 ? 'checked' : ''}
					preceiver="${item.receiver}"	pmobile="${item.mobile}"/></td>
