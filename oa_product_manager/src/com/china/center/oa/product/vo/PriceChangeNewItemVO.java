 ...
 * @author ZHUZHU
 * @version 2010-10-4
 * @see PriceChangeNewItemVO
 * @since 1.0
 */
@Entity(inherit = true)
public class PriceChangeNewItemVO extends PriceChangeNewItemBean
{
    ...
    public String toString()
    {
        ...
        retValue.append("PriceChangeNewItemVO ( ").append(super.toString()).append(TAB).append("productName = ").append(
