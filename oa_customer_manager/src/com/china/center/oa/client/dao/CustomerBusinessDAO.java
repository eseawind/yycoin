 ...
 * @author ZHUZHU
 * @version 2010-10-6
 * @see CustomerBusinessDAO
 * @since 1.0
 */
public interface CustomerBusinessDAO extends DAO<CustomerBusinessBean, CustomerBusinessBean>
{
	boolean updateValid(String id, int valid);
	
	List<CustomerBusinessBean> queryEntityBeansByCidAndValid(String cid, int valid);
}
