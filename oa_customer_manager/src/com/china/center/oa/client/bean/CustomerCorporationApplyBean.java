...
@Entity(name = "组织客户", inherit = true)
@Table(name = "T_CENTER_CUSTOMER_CORPORATION_APPLY")
public class CustomerCorporationApplyBean extends AbstractCustomerCorporationBean
{
	@Id
	private String id = "";
	 ...
	 * 
	 */
	public CustomerCorporationApplyBean()
	{
	}
