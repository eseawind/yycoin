...
@Table(name = "T_CENTER_CUSTOMER_INDIVIDUAL_APPLY")
public class CustomerIndividualApplyBean extends AbstractCustomerIndividualBean
{
	@Id
	private String id = "";
	 ...
	 * 
	 */
	public CustomerIndividualApplyBean()
	{
	}
