...
@Entity(inherit = true)
public class CustomerIndividualVO extends CustomerIndividualBean
{
	...
	@Ignore
	private List<CustomerDistAddrVO> custAddrVOList = null;

	public CustomerIndividualVO()
	{
	}
	 ...
	 */
	public List<CustomerDistAddrVO> getCustAddrVOList()
	{
	 ...
	 */
	public void setCustAddrVOList(List<CustomerDistAddrVO> custAddrVOList)
	{
