...
<input type="hidden" name="method" value="updateStorage">
<input type="hidden" name="id" value="${bean.id}">
<input type="hidden" name="depotpartId" value="${bean.depotpartId}">
<p:navigation
	height="22">
	<td width="550" class="navigation"><span style="cursor: pointer;"
		onclick="javascript:history.go(-1)">储位管理</span> &gt;&gt; 修改储位</td>
	<td width="85"></td>
</p:navigation> <br>
...
<p:body width="98%">
	...
	<p:subBody width="100%">
		<p:class value="com.china.center.oa.product.bean.StorageBean" opr="1"/>
		...
		<p:table cells="1">
			...
			<p:pro field="depotpartId" innerString="readonly=true" value="${bean.depotpartName}"/>
