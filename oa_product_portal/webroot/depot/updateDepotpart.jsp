...
<form name="addApply" action="../depot/depotpart.do" method="post">
<input type="hidden" name="method" value="updateDepotpart" />
<input type="hidden" name="id" value="${bean.id}" />
<p:navigation
	height="22">
	<td width="550" class="navigation"><span style="cursor: pointer;"
		onclick="javascript:history.go(-1)">仓区管理</span> &gt;&gt; 修改仓区</td>
	<td width="85"></td>
</p:navigation> <br>
...
<p:body width="98%">
	...
	<p:subBody width="100%">
		<p:class value="com.china.center.oa.product.bean.DepotpartBean" opr="1"/>
