...
<form name="formEntry" action="../project/project.do" method="post">
<input	type="hidden" name="method" value="selectProject">
<input type="hidden" value="1" name="load">
<input
    type="hidden" value="${selectMode}" name="selectMode"> <p:navigation
	height="22">
	<td width="550" class="navigation">所有项目</td>
	<td width="85"></td>
</p:navigation> <br>
        ...
        <table width="100%" align="center" cellspacing='1' class="table0"
            ...
            <tr class="content1">
                ...
                <td align="center"><input type="text" name="name" onkeypress="press()"
                    value="${name}"></td>
                <td width="15%" align="center">项目编码</td>
			...
			<c:forEach items="${beanList}" var="item" varStatus="vs">
				<tr class="${vs.index % 2 == 0 ? 'content1' : 'content2'}">
					<td align="center"><input type='${selectMode == 1 ? "radio" : "checkbox"}' name="beans"
						pname="${item.projectName}" pvalue="${item.projectCode}"
						${vs.index == 0 ? 'checked' : ''}/></td>
					<td align="center" onclick="hrefAndSelect(this)">${item.projectName}</td>
					<td align="center" onclick="hrefAndSelect(this)">${item.projectCode}</td>
				</tr>
			</c:forEach>
		</table>
