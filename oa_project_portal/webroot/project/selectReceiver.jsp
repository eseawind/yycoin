...
function sures()
{
	...
	if (oo)
    opener.setReceiverVal(oo,$O('selTypetm').value);
    closes();
}
...
<form name="formEntry" action="../project/project.do" method="post"><input
	type="hidden" name="method" value="selectReceiver">
...
<p:body width="100%">
	...
	<p:subBody width="90%">
		...
		<p:formTurning form="formEntry" method="selectReceiver"></p:formTurning>
