 ...
 * @author ZHUZHU
 * @version 2010-10-6
 * @see CustomerDistAddrHisDAOImpl
 * @since 1.0
 */
public class CustomerDistAddrHisDAOImpl extends
		BaseDAO<CustomerDistAddrHisBean, CustomerDistAddrHisBean> implements
		CustomerDistAddrHisDAO {
