 ...
 * @author ZHUZHU
 * @version 2010-10-6
 * @see CustomerContactHisDAOImpl
 * @since 1.0
 */
public class CustomerContactHisDAOImpl extends	BaseDAO<CustomerContactHisBean, CustomerContactHisBean> implements CustomerContactHisDAO 
{
