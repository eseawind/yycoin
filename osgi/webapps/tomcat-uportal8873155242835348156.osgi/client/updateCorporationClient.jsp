...
<%@include file="../common/common.jsp"%>
	...
	<p:class value="com.china.center.oa.client.bean.CustomerCorporationApplyBean" opr="1"/>
	...
	<p:table cells="2">
		...
		<p:pro field="industry" innerString="quick=true">
         ...
         <textarea name='formerCustName'
				id='formerCustName' rows=2 cols=60 readonly=readonly><c:out value="${bean.formerCustName}" /></textarea>
