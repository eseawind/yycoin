...
<form name="addApply" action="../client/client.do" method="post">
	...
	<input type="hidden" name="refDepartCustId" value="">
	<input type="hidden" name="refCorpCustId" value="">
	<input type="hidden" name="formerCust" value="">
		
	<p:navigation height="22">
		<td width="550" class="navigation"><span
			style="cursor: pointer;" onclick="javascript:history.go(-1)">客户管理</span>	&gt;&gt; 申请增加客户</td>
		<td width="85"></td>
	</p:navigation>
	...
	<div id="container-1" style="display: none;">
		...
		<div id="fragment-basic-info">
			<c:if test="${stype==1}">
			<%@include file="addIndividualClient.jsp"%>
			</c:if>
			<c:if test="${stype==2}">
			<%@include file="addDepartClient.jsp"%>
			</c:if>
			<c:if test="${stype==3}">
			<%@include file="addCorporationClient.jsp"%>
			</c:if>
		</div>
...
<div id="dlg_linkman" title="新增联系人信息" style="width: 700px;">
	<table id="tbl_linkman_1" class='table0' style="width: 100%;">
		<tbody>
			<tr class="content1">
				<td width="15%">姓名</td>
				<td width="35%"><input id="name1" oncheck="notNone;"/>&nbsp;<font color="#FF0000">*</font> </td>
				<td width="15%">性别</td>
				<td width="35%"><select id="sex1">
					<p:option type="gender"></p:option>
					</select> </td>
			</tr>
			<tr class="content1">
				<td width="15%">年龄段</td>
				<td width="35%"><select id="personal1">
			...
			<tr class="content1">
				...
				<td width="15%">手机</td>
				<td width="35%"><input id="handphone1" oncheck='notNone;isMathNumber' size=11 maxlength='11'/>&nbsp;<font color="#FF0000">*</font> </td>
			</tr>
			<tr class="content1">
				<td width="15%">固话</td>
			...
			<tbody>
				<tr class="content1">
					...
					<select id="custAccountType">
							<p:option type="accountType"></p:option>
				...
				<tr class="content1">
					...
					<td width="35%"><select id="myAccountType">
						<p:option type="accountType"></p:option>
