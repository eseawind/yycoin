...
function load()
{
	 ...
	 guidMap = {
		 ...
		 url: '../client/client.do?method=queryCanAssignClient',
		 colModel : [
...
function addBean()
{
    ...
    if (clis.length > 0)
    {
        ...
        {
            $ajax('../client/client.do?method=addAssignApply&cids=' + str, callBackFun);
        }
    }
}
...
{
	$l('../client/client.do?method=rptQueryClientBatchTrans&load=1&selectMode=1');
}

function doSearch()
{
    $modalQuery('../admin/query.do?method=popCommonQuery2&key=queryCanAssignClient');
}
