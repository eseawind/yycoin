...
function addBean(opr)
{
    ...
    if ("0" == opr)
    {
        submit('确定修改办公采购申请?', null, checks);
    }
    
    if ("1" == opr)
    {
        submit('确定提交办公采购申请?', null, checks);
    }
    
    if ("2" == opr)
    {
        submit('稽核修改费用,每项费用只能减少.确定提交稽核修改办公采购申请?', null, checks);
    }
}
                ...
                <table width="100%" border="0" cellspacing='1' id="tables">
                    ...
                    <c:forEach items="${bean.itemVOList}" var="itemEach" varStatus="vs">
			         ...
			         <input type="text" style="width: 100%"
			                    name="i_productName" value="${itemEach.productName}" oncheck="notNone;">
			         </td>
			         <td align="left">
			         <input type="text" style="width: 100%"
			                    name="i_amount" value="${itemEach.amount}" oncheck="notNone;isInt">
			         </td>
			         <td align="left">
			         <input type="text" style="width: 100%"
			                    name="i_prices" value="${my:formatNum(itemEach.prices/ 100.0)}" oncheck="notNone;isFloat3">
			         </td>
