...
var gurl = '../customer/address.do?method=';
var addUrl = '../customer/address.do?method=';
var ukey = 'Address';
...
function load()
{
     ...
     guidMap = {
         ...
         colModel : [
             ...
             {display: '地址', name : 'fullAddress',  width : '40%'},
             {display: '收货人', name : 'receiver',  width : '10%'},
             {display: '手机', name : 'mobile',  width : '10%'},
             {display: '固定电话', name : 'telephone',  width : 'auto'}
             ],
         extAtt: {
...
function delBean(opr, grid)
{
    ...
    {    
        ...
        $ajax(gurl + 'del' + ukey + '&id=' + getRadioValue('checkb'), callBackFun);
    }
    else
    $error('不能操作');
}
