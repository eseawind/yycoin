...
function closesd()
{
	...
	document.location.href = '../customer/queryCanAssignCustomer.jsp';
}
...
<form name="formEntry" action="../customer/customer.do" method="post"><input
	type="hidden" name="method" value="rptQueryCustomerBatchTrans"><input
...
<p:body width="100%">
	...
	<p:subBody width="90%">
		...
		<p:formTurning form="formEntry" method="rptQueryCustomerBatchTrans"></p:formTurning>
