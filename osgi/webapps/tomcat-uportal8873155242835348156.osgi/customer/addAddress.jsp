...
<form name="outForm" action="../customer/address.do?method=addAddress" method="post">
<input type=hidden name="customerId" value="" />

<p:navigation
	height="22">
	<td width="550" class="navigation">客户管理 &gt;&gt; 填写客户收货信息</td>
				<td width="85"></td>
</p:navigation> <br>
...
<p:body width="100%">
	...
	<p:subBody width="98%">
		...
		<p:cell title="客户" end="true">
				<input type="text" name="customerName" size=80 maxlength="100" value=""
		  ...
		  <tr  class="content1">
		  	...
		  	<td>选择地址：</td>
		  	<td colspan="2">
			  	<select name="provinceId" quick=true onchange="changes(this)" values="" class="select_class" oncheck="notNone;"></select>&nbsp;&nbsp;
	         	<select name="cityId" quick=true onchange="changeArea()" values="" class="select_class" oncheck="notNone;"></select>&nbsp;&nbsp;
	         	<select name="areaId" quick=true values="" class="select_class" oncheck="notNone;"></select>
		  	</td>
		  </tr>	
		  ...
		  <tr  class="content2">
		  	...
		  	<td>详细地址：</td>
		  	<td colspan="2">
		  		<input type="text" name="address" value="" oncheck="notNone;" size=100 maxlength="300" style="width: 100%;">
		  	</td>
		  </tr>
		  
		  <p:cell title="收 货 人" end="true">
             <input type="text" name="receiver" value="" oncheck="notNone;" size=20 maxlength="30">
          </p:cell>
          
          <tr  class="content2">
            <td>手&nbsp;&nbsp;&nbsp;&nbsp;机：</td>
            <td colspan="3">
              <input type="text" name="mobile" value="" oncheck="notNone;isMathNumber" size=11 maxlength="11"><font color="#FF0000">*</font>
              &nbsp;&nbsp;固定电话：&nbsp;&nbsp;            
              <input type="text" name="telephone" value="" size=20 maxlength="30">
            </td>
          </tr>
