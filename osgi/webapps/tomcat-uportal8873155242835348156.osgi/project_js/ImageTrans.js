...
function loadImage(divName, url)
{
	add_css('#' + divName + '{border:1px solid #000;width:600px; height:500px; background:#FFF center no-repeat;}');
	var container = $$(divName), src = url,
	options = {
