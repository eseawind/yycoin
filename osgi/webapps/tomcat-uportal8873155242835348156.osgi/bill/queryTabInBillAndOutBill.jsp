...
<p:navigation
	height="22">
	<td width="550" class="navigation">收付款单列表</td>
	<td width="85"></td>
</p:navigation> <br>
	...
	<p:subBody width="100%">
		<table width="100%" align="center" cellspacing='1' class="table0"
			...
			<tr align=center class="content0">
				...
				<td align="center" width="13%"><strong>类型</strong></td>
			</tr>

			<c:forEach items="${inbillList}" var="item" varStatus="vs">
				<tr class="${vs.index % 2 == 0 ? 'content1' : 'content2'}">
					<td align="center" onclick="hrefAndSelect(this)"><a href="../sail/out.do?method=findOut&fow=99&outId==${item.outId}" />${item.outId}</a></td>
					<td align="center" onclick="hrefAndSelect(this)">收款单</td>

				</tr>
				</c:forEach>
				<c:forEach items="${outbillList}" var="item" varStatus="vs">
				<tr class="${vs.index % 2 == 0 ? 'content1' : 'content2'}">
					<td align="center" onclick="hrefAndSelect(this)"><a href="../finance/bill.do?method=findOutBill&outId==${item.id}" />${item.id}</a></td>
					<td align="center" onclick="hrefAndSelect(this)">付款单</td>
