...
<form name="formEntry" action="../finance/bill.do" method="post"><input
	type="hidden" name="method" value="rptQueryInBill"><input
	type="hidden" value="1" name="load"><input
    type="hidden" value="${selectMode}" name="selectMode"> 

<p:navigation
	height="22">
	<td width="550" class="navigation">收款单管理</td>
	<td width="85"></td>
</p:navigation> <br>
...
<p:body width="100%">
	...
	<p:title>
		<td class="caption"><strong>收款单列表：</strong></td>
	</p:title>
	...
	<p:subBody width="90%">
		<table width="100%" align="center" cellspacing='1' class="table0"
			...
			<tr align=center class="content0">
				...
				<td align="center" class="td_class"><strong>收款单号</strong></td>
		...
		<p:formTurning form="formEntry" method="rptQueryInBill"></p:formTurning>
