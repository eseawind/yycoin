...
<p:navigation height="22">
	<td width="550" class="navigation"><span style="cursor: pointer;"
		onclick="javascript:history.go(-1)">产品价格配置管理</span> &gt;&gt; 增加产品价格配置</td>
	<td width="85"></td>
</p:navigation> <br>
...
<p:body width="100%">
	...
	<p:subBody width="98%">
		...
		<p:table cells="2">
			...
			<c:if test="${type=='1'}">
				<p:cell title="是否受金银价波动影响" end="true">
					<input type="checkbox" name='cftype' id ='cftype' />不受金银价波动影响
				</p:cell>
			
				<p:cell title="邮票总价" end="true">
					<input type=text name='price' id ='price' value='0.00' oncheck="notNone;isFloat;"  maxlength="12" />
				</p:cell>
				
				<p:cell title="辅料费用" end="true">
					<input type=text name='gsPriceUp' id ='minPrice' value='0.00' oncheck="notNone;isFloat;"  maxlength="12" />
				</p:cell>
			</c:if>
			
			<c:if test="${type=='0'}">
				<p:cell title="建议销售价" end="true">
					<input type=text name='minPrice' id ='minPrice' value='0.00' oncheck="notNone;isFloat;"  maxlength="12" />
				</p:cell>
