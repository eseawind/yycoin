...
function confirm(id)
{
	document.location.href = '../stock/stock.do?method=confirmProduct&id=${bean.id}&itemId=' + id;
}
	...
	<p:subBody width="100%">
		<table width="100%" border="0" cellspacing='1' id="tables">
			<tr align="center" class="content0">
				...
				<td width="10%" align="center">确 定</td>
			</tr>
			...
			<c:forEach items="${bean.itemVO}" var="item" varStatus="vs">
				<tr class='${vs.index % 2 == 0 ? "content1" : "content2"}'>
					...
					<td align="center">
					<c:if test="${item.extraStatus == 0}">
					<a title="确认"
						href="javascript:confirm('${item.id}')">
