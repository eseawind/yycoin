...
<form name="formEntry" action="../depot/storage.do" method="post"><input
	type="hidden" name="method" value="updateGSOut"> 
	...
	<p:subBody width="98%">
		<p:table cells="1">
			...
			<p:cell title="备注" end="true">
				<textarea rows=3 cols=55 oncheck="maxLength(200);" name="description"><c:out value="${bean.description}"></c:out></textarea>
			</p:cell>
        ...
        <table width="98%" border="0" cellpadding="0" cellspacing="0"
            ...
            <tr>
                ...
                <table width="100%" border="0" cellspacing='1' id="tables">
                    ...
                    <tr class="content2">
	                    <td align="center">
				         <select name="srcDepot" class="select_class" style="width: 100%;" values="${item.deportId}" onchange="srcDepotChange(this)" >
				         <option value="">--</option>
				         ...
				         <td align="center">
				         <select name="srcDepotpart" class="select_class" style="width: 100%;" values="${item.depotpartId}">
				         <option value="">--</option>
				         <c:forEach var="item2" items="${depotpartList}">
				             <option value="${item2.id}">${item2.name}</option>
				         </c:forEach>
				         </select>
				         </td>
				         <td align="center"><input type="text" 
				         style="width: 100%;cursor: pointer;" readonly="readonly" value="${item.productName}" oncheck="notNone" name="srcProductName" onclick="selectProduct(this)">
				         <input type="hidden" name="srcProductId" value="${item.productId}">
				         </td>
				         <td align="center"><input type="text" style="width: 100%"
				                    name="srcAmount" value="${item.amount}" oncheck="notNone;isNumber;range(1)"></td>
				         <td align="center"><input type="text" style="width: 100%"
				                    name="srcPrice" value="${item.price}" oncheck="notNone;isFloat" readonly='readonly'>
				         </td>
				         <td align="center"><input type="text" style="width: 100%"
				                    name="goldWeight" value="${item.goldWeight}" oncheck="notNone;isNumber">
				         </td>
				         <td align="center"><input type="text" style="width: 100%"
				                    name="goldPrice" value="${item.goldPrice}" oncheck="notNone;isFloat" >
				         </td>
				         <td align="center"><input type="text" style="width: 100%"
				                    name="silverWeight" value="${item.silverWeight}" oncheck="notNone;isNumber">
				         </td>
				         <td align="center"><input type="text" style="width: 100%"
				                    name="silverPrice" value="${item.silverPrice}" oncheck="notNone;isFloat" >
				         </td>
				        </tr>
                    </c:forEach>
                </table>
