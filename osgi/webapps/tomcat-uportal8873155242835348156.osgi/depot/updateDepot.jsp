...
<form name="formEntry" action="../depot/depot.do" method="post">
<input type="hidden" name="method" value="updateDepot">
<input type="hidden" name="id" value="${bean.id}">
<p:navigation
	height="22">
	<td width="550" class="navigation"><span style="cursor: pointer;"
		onclick="javascript:history.go(-1)">仓库管理</span> &gt;&gt; 修改仓库</td>
	<td width="85"></td>
</p:navigation> <br>
...
<p:body width="98%">
	...
	<p:subBody width="100%">
		<p:class value="com.china.center.oa.product.bean.DepotBean" opr="1"/>
		...
		<p:table cells="1">
			...
			<p:pro field="status" innerString="style='width:240px'">
				<p:option type="orgStatus"></p:option>
			</p:pro>
