	...
	<p:subBody width="98%">
		<table width="100%" align="center" cellspacing='1' class="table0">
			<tr align=center class="content0">
				...
				<td align="center" class="td_class" onclick="tableSort(this)"><strong>仓区内前数量</strong></td>
				<td align="center" class="td_class" onclick="tableSort(this)"><strong>异动数量</strong></td>
				<td align="center" class="td_class" onclick="tableSort(this)"><strong>仓区内后数量</strong></td>
			...
			<c:forEach items="${listStorageLog}" var="item"
				...
				<tr class="${vs.index % 2 == 0 ? 'content1' : 'content2'}">
					...
					<td align="center" onclick="hrefAndSelect(this)">${item.preAmount1}</td>
					</c:if>
					<c:if test="${priceKey == 1}">
					<td align="center" onclick="hrefAndSelect(this)">${item.preAmount11}</td>
					</c:if>
					...
					<c:if test="${priceKey == 1}">
					<td align="center" onclick="hrefAndSelect(this)">${item.afterAmount11}</td>
					</c:if>
