...
function load()
{
	...
	highlights(formEntry, ['驳回'], 'red');
	highlights(formEntry, ['询价中'], 'blue');
}
...
function process(id)
{
	document.location.href = '../stock/ask.do?method=preForProcessAskPrice&fw=queryPriceAsk&id=' + id;
}
...
<form name="formEntry" action="../stock/ask.do"><input
	type="hidden" name="method" value="queryAllPriceAsk"> <input
	...
	<td width="550" class="navigation">询价管理 &gt;&gt; 查询询价</td>
	<td width="85"></td>
</p:navigation> <br>
