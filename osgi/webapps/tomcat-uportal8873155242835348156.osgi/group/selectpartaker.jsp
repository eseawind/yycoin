	...
	<p:subBody width="90%">
		<table width="100%" align="center" cellspacing='1' class="table0"
			...
			<tr class="content1">
				...
				<td align="center"><input type="text" name="staCode" onkeypress="press()"
					value="${code}"></td>
			</tr>
		...
		<table width="100%" align="center" cellspacing='1' class="table0"
			...
			<c:forEach items="${beanList}" var="item" varStatus="vs">
				<tr class="${vs.index % 2 == 0 ? 'content1' : 'content2'}">
					...
					pname="${item.name}"  pvalue="${item.id}"/></td>		
