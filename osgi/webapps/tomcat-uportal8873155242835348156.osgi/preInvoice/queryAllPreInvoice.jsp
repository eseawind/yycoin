...
function load()
{
     ...
     guidMap = {
         title: '销售预开票列表',
         url: gurl + 'queryAllPreInvoice&type=22',
         colModel : [
...
function exports()
{
    document.location.href = gurl + 'exportPreInvoiceApply';
}

function doSearch()
{
    $modalQuery('../admin/query.do?method=popCommonQuery2&key=tcp.queryAllPreInvoice');
}
