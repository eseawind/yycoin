...
$.blockUI   = function(opts, notBing) { install(window, opts);if (!notBing)bingEsc();};
$.unblockUI = function(opts) { removeEsc();remove(window, opts); };
...
function bingEsc()
{
	addEventCommon(document, 'keydown', besc);
}

/**
 * remove ESC in blockUI
 */
function removeEsc()
{
    removeEventCommon(document, 'keydown', besc);
}
