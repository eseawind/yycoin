...
function showCalendarInner(el, format, showsTime, showsOtherMonths)
{
    ...
    else
    {
        ...
        cal.setRange(MIN_YEAR, MAX_YEAR);
...
function getNextButton(el)
{
    ...
    {
        return getNextButton(el.nextSibling);
    }
}
...
Calendar.prototype.create = function (_par)
{
    ...
    var cal = this;
    var hh = function (text, cs, navtype, title)
    {
        ...
        if (!title)
        {title = '';}
        cell.innerHTML = "<div title='" + title + "'unselectable='on'>" + text + "</div>";
        return cell;
    }
    ;
    ...
    hh("R", 1, 4000, Calendar._TT["RESET_TITLE"]).ttip = Calendar._TT["RESET_TITLE"];
    ...
    if (this.isPopup)
    {
        ...
        hh("&#x00d7;", 1, 200, Calendar._TT["CLOSE_TITLE"]).ttip = Calendar._TT["CLOSE"];
    }
...
Calendar._checkCalendar = function(ev)
{
    ...
    for (; el != null && el != calendar.element;
    el = el.parentNode);
    if (el == null)
    {
