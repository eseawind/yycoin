...
<p:navigation height="22">
	<td width="550" class="navigation"><span style="cursor: pointer;"
		onclick="javascript:history.go(-1)">采购预付款管理</span> &gt;&gt; 修改采购预付款</td>
	<td width="85"></td>
</p:navigation> <br>
...
<p:body width="100%">
	...
	<p:subBody width="98%">
		<p:class value="com.china.center.oa.finance.bean.StockPrePayApplyBean" opr="1"/>

		<p:table cells="1">
			
			<p:pro field="providerId" innerString="readonly=true size='60'" value="${bean.providerName}">
			...
			<p:pro field="moneys" innerString="oncheck='isFloat'" value="${my:formatNum(bean.moneys)}"/>
