        ...
        <table width="98%" border="0" cellpadding="0" cellspacing="0"
            ...
            <tr>
                ...
                <table width="100%" border="0" cellspacing='1' id="tables">
                    ...
                    <c:forEach items="${bean.stafferProjectList}" var="itemEach" varStatus="vs">
                   <tr class="content1" id="trCopy" style="display: none;">
			         <td align="left">
			         <input type=text name = 'staffer'  id = 'staffer' value="${itemEach.pstafferName }" onclick="selectAllstaffer(this)"  readonly   style="width: 100%" >
			         <input type="hidden" name="s_prostafferId" value=""> 
			         </td>
			         <td align="left">
			         <select name="role" class="select_class" style="width: 100%;" oncheck="notNone">
			            <p:option type="204" empty="true"></p:option>
			         </select>
			         </td>
            ...
            <tr>
                ...
                <table width="100%" border="0" cellspacing='1' id="tables_pay">
                    <tr align="center" class="content0">
                     ...
                     <c:forEach items="${bean.proLineProjectList}" var="itemEach" varStatus="vs">
	                   <tr class="content1" id="trCopy_pay" style="display: none;">
					         <td align="left">
					         <input type=text name = 'projectpro'  value="${itemEach.projectproName }"  id = 'projectpro'  onclick="selectProjectpro(this)"  readonly  style="width: 100%" >
					         <input type="hidden" name="s_projectproId"> 
					         </td>
					         
					         <td align="left"><input type="text" value="${itemEach.procount }" style="width: 100%"
					                    name="procount"  >
					         </td>
					         
					         <td align="left">
					         <input type="text" value="${itemEach.prounitprice }" style="width: 100%"  name="prounitprice"  >
					         </td>
