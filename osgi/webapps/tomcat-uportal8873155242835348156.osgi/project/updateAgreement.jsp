            ...
            <tr>
                ...
                <table width="100%" border="0" cellspacing='1' id="tables_Pro">
                    <tr align="center" class="content0">
                     ...
                     <c:forEach items="${bean.proLineList}" var="itemEach" varStatus="vs">
	                   <tr class="content1" id="trCopy" style="display: none;">
				         <td align="left">
				         <input type=text name = 'agreementPro'  id = 'agreementPro' value="${itemEach.projectproName }"  onclick="selectAgreementpro(this)"   style="width: 100%" >
				         <input type="hidden" name="s_agreementproId" value=""> 
				         </td>
				         <td align="left">
				         <input type=text name = 'proCounts' value="${itemEach.procount }"  id = 'proCounts'  oncheck = ""    style="width: 100%" >
				         </td>
				         <td align="left">
				         <input type=text name = 'proUnitPrice' value="${itemEach.prounitprice }"  id = 'proUnitPrice'  oncheck = ""    style="width: 100%" >
				         </td>
        ...
        <table width="98%" border="0" cellpadding="0" cellspacing="0"
            ...
            <tr>
                ...
                <table width="100%" border="0" cellspacing='1' id="tables_pay">
                    ...
                    <c:forEach items="${bean.payLineProjectList}" var="itemEach" varStatus="vs">
	                  <tr class="content1" id="trCopy_pay" style="display: none;">
				    	<td align="left">
				   		 <select name="payType" class="select_class" style="width: 100%;" oncheck="notNone">
				            <p:option type="206" empty="true"></p:option>
				         </select>
				         </td>
				         <td align="left"><input type="text" style="width: 100%"
				                    name="payMoney" value="${itemEach.payMoney }" >
				         </td>
				         
				         <td align="left">
				         <input type=text name = 'payTime'  id = 'payTime'  oncheck = "" value="${itemEach.payTime }"  readonly=readonly class='input_class' size = '20' ><img src='../images/calendar.gif' style='cursor: pointer' title='请选择时间' align='top' onclick='return calDateInner(this, "payTime");' height='20px' width='20px'/>
				         </td>
				         <td align="left"><input type="text" style="width: 100%"
				                    name="finishDays" value="${itemEach.finishDays }" >
				         </td>
				         <td align="left"><input type="text" style="width: 100%" onclick="selectPaycurrentTask1(this)"
				                    name="paycurrentTask1" value="${itemEach.paycurrentTask1 }" >
				          ...
				          <td align="left"><textarea rows="3" cols="20" onclick="selectPayBeforeTask(this)" style="width: 100%"
				                    name="beforeTask" id="beforeTask" >${itemEach.beforeTask }</textarea>
				          ...
				          <td align="left"><textarea rows="3" cols="20" onclick="selectPayAfterTask(this)" style="width: 100%"
				                    name="afterTask" id="afterTask">${itemEach.afterTask }</textarea>
            ...
            <tr>
                ...
                <table width="100%" border="0" cellspacing='1' id="tables_trans">
                    <tr align="center" class="content0">
                        ...
                        <td width="11%" align="center">交付地点</td>
                    ...
                    <c:forEach items="${bean.transLineProjectList}" var="itemEach" varStatus="vs">
	                  <tr class="content1" id="trCopy_trans" style="display: none;">
					    	<td align="left">
					            ...
					            <p:option type="207" empty="true"></p:option>
					         </select>
					         </td>
					         <td align="left">
					         <select name="transobj" class="select_class" style="width: 100%;" oncheck="notNone">
					            <p:option type="213" empty="true"></p:option>
					         </select>
					         </td>
					         <td align="left"><input type="text" style="width: 100%"
					                    name="transobjCount" value="${itemEach.transobjCount }" >
					         </td>
					         <td align="left">
					         <input type=text name = 'transTime'  id = 'transTime'  oncheck = ""  value="${itemEach.transTime }"  readonly=readonly class='input_class' size = '20' ><img src='../images/calendar.gif' style='cursor: pointer' title='请选择时间' align='top' onclick='return calDateInner(this, "transTime");' height='20px' width='20px'/>
					         </td>
					         
					          <td align="left"><input type="text" style="width: 100%"
					                    name="transDays" value="${itemEach.transDays }" >
					         </td>
					          <td align="left"><input type="text" style="width: 100%" onclick="selectTrancurrentTask1(this)"
					                    name="trancurrentTask1"  value="${itemEach.trancurrentTask1 }" >
					                    <input type="hidden" name="s_trancurrentTask1id" value=""> 
					         </td>
					          <td align="left"><input type="text" style="width: 100%"
					                    name="receiver"  value="${itemEach.receiver }"  onclick="selectReceiver(this)">
					          ...
					          <td align="left"><textarea rows="3" cols="20" onclick="selectTranBeforeTask(this)" style="width: 100%"
					                    name="beforeTask1" id="beforeTask1">${itemEach.beforeTask1 }</textarea>
					         ...
					         <td align="left"><textarea rows="3" cols="20" onclick="selectTranAfterTask(this)" style="width: 100%"
					                    name="afterTask1" id="afterTask1">${itemEach.afterTask1 }</textarea>
                    ...
                    <tr align="center" class="content0">
	                  ...
	                  <tr class="content1" id="trCopy_invoice" style="display: none;">
					    	<td align="left">
					            ...
					            <p:option type="208" empty="true"></p:option>
					         </select>
					         </td>
					         <td align="left"><input type="text" style="width: 100%"
					                    name="invoiceMoney" value="${itemEach.invoiceMoney }" >
					         </td>
					         <td align="left">
					         <input type=text name = 'invoiceTime'  id = 'invoiceTime'  oncheck = ""  value="${itemEach.invoiceTime }"  readonly=readonly class='input_class' size = '20' ><img src='../images/calendar.gif' style='cursor: pointer' title='请选择时间' align='top' onclick='return calDateInner(this, "invoiceTime");' height='20px' width='20px'/>
					         </td>
					         
					          <td align="left"><input type="text" style="width: 100%"
					                    name="finishiDays1" value="${itemEach.finishiDays1 }" >
					         </td>
					         
					         <td align="left"><input type="text" style="width: 100%" onclick="selectinvocurrentTask(this)"
					                    name="invocurrentTask" value="${itemEach.invocurrentTask }" >
					          ...
					          <td align="left"><textarea rows="3" cols="20" onclick="selectInvoiceBeforeTask(this)" style="width: 100%"
					                    name="beforeTask2" id="beforeTask2">${itemEach.beforeTask2 }</textarea>
					          ...
					          <textarea rows="3" cols="20" onclick="selectInvoiceAfterTask(this)" style="width: 100%"
					                    name="afterTask2" id="afterTask2">${itemEach.afterTask2 }</textarea>
    ...
    <tr class="content1" id="trCopy_pay" style="display: none;">
    	<td align="left">
         ...
         <td align="left"><input type="text" style="width: 100%"
          ...
          <td align="left"><textarea rows="3" cols="20" onclick="selectPayBeforeTask(this)" style="width: 100%"
                    name="beforeTask" ></textarea>
                    <input type="hidden" name="payBeforeids" value=""> 
         </td>
          <td align="left"><textarea rows="3" cols="20" onclick="selectPayAfterTask(this)" style="width: 100%"
                    name="afterTask" ></textarea>
                    <input type="hidden" name="payAfterids" value=""> 
         </td>
        <td width="5%" align="center"><input type=button name="pay_del_bu"
            value="&nbsp;删 除&nbsp;" class=button_class onclick="removeTr(this)"></td>
    </tr>
    ...
    <tr class="content1" id="trCopy_trans" style="display: none;">
    	<td align="left">
         ...
         <input type=text name = 'transTime'  id = 'transTime'  oncheck = ""  value = ''  readonly=readonly class='input_class' size = '20' ><img src='../images/calendar.gif' style='cursor: pointer' title='请选择时间' align='top' onclick='return calDateInner(this, "transTime");' height='20px' width='20px'/>
          ...
          <td align="left"><input type="text" style="width: 100%"
                    name="transPlace" value="" >
         </td>
          <td align="left"><input type="text" style="width: 100%"
                    name="receiver" value="" onclick="selectReceiver(this)">
                    <input type="hidden" name="receiverid" value="" />
         </td>
          <td align="left"><input type="text" onclick="selectTranBeforeTask(this)" style="width: 100%"
                    name="beforeTask1" value="" >
                    <input type="hidden" name="tranBeforeids" value=""> 
         </td>
         <td align="left"><input type="text" onclick="selectTranAfterTask(this)" style="width: 100%"
                    name="afterTask1" value="" >
                     <input type="hidden" name="tranAfterids" value=""> 
         </td>
        <td width="5%" align="center"><input type=button name="pay_del_bu"
            value="&nbsp;删 除&nbsp;" class=button_class onclick="removeTr(this)"></td>
    </tr>
    ...
    <tr class="content1" id="trCopy_invoice" style="display: none;">
    	<td align="left">
         ...
         <input type=text name = 'invoiceTime'  id = 'invoiceTime'  oncheck = ""  value = ''  readonly=readonly class='input_class' size = '20' ><img src='../images/calendar.gif' style='cursor: pointer' title='请选择时间' align='top' onclick='return calDateInner(this, "invoiceTime");' height='20px' width='20px'/>
          ...
          <td align="left"><input type="text" style="width: 100%" onclick="selectInvoiceBeforeTask(this)"
                    name="beforeTask2" value="" >
                    <input type="hidden" name="invoiceBeforeids" value=""> 
                    
         </td>
          <td align="left"><input type="text" style="width: 100%" onclick="selectInvoiceAfterTask(this)"
                    name="afterTask2" value="" >
                    <input type="hidden" name="invoiceAfterids" value=""> 
         </td>
        <td width="5%" align="center"><input type=button name="pay_del_bu"
            value="&nbsp;删 除&nbsp;" class=button_class onclick="removeTr(this)"></td>
    </tr>
