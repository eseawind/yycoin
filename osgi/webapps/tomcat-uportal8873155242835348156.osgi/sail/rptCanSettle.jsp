...
<form name="formEntry" action="../sail/out.do" method="post"><input
	type="hidden" name="method" value="rptCanSettle">
	...
	<p:subBody width="98%">
		<table width="100%" align="center" cellspacing='1' class="table0"
			...
			<tr align=center class="content0">
				...
				<td align="center" width="10%"><strong>可结算数量</strong></td>
				<td align="center" width="10%"><strong>已结算数量</strong></td>
		...
		<p:formTurning form="formEntry" method="rptCanSettle"></p:formTurning>
