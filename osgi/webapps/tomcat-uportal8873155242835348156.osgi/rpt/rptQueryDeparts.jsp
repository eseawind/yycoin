...
<form name="formEntry" action="../admin/pop.do" method="post"><input
	type="hidden" name="method" value="selectDeparts"><input
...
<p:navigation
	height="22">
	<td width="550" class="navigation">部门管理</td>
	<td width="85"></td>
</p:navigation> <br>
...
<p:subBody width="90%">
		<table width="100%" align="center" cellspacing='1' class="table0"
			...
			<tr class="content1">
				...
				<td align="center"><input type="text" name="name" onkeypress="press()"
					value="${name}"></td>
				<td width="15%" align="center">部门编码</td>
	...
	<p:title>
		<td class="caption"><strong>部门列表：</strong></td>
	</p:title>
	...
	<p:subBody width="90%">
		<table width="100%" align="center" cellspacing='1' class="table0"
			...
			<!-- ${vs.index == 0 ? 'checked' : ''} -->
			<c:forEach items="${allIndustry}" var="item" varStatus="vs">
